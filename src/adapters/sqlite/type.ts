...
export type NativeDispatcher = {
  ...
  find: (arg1: TableName<any>, arg2: RecordId, arg3: ResultCallback<DirtyFindResult>) => void
...
export type NativeBridgeType = {
  ...
  findSynchronous?: (
    ...
    arg2: TableName<any>,
    arg3: RecordId,
  ) => SyncReturn<DirtyFindResult>
  querySynchronous?: (
    arg1: ConnectionTag,
    arg2: TableName<any>,
    arg3: SQL,
  ) => SyncReturn<DirtyQueryResult>
  ...
  unsafeResetDatabaseSynchronous?: (
    arg1: ConnectionTag,
    arg2: SQL,
    arg3: SchemaVersion,
  ) => SyncReturn<void>
